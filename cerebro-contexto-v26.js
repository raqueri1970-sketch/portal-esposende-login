/* Portal Esposende — contexto conversacional unificado Portal + Siri v28 */
(function(){
  const KEY='portal_esposende_cerebro_contexto_v28', TTL=30*60*1000;
  ...
  window.fetch=async function(input,init){
    try{
      ...
      if(/portal-cerebro(?:-integrado)?/i.test(url)&&init&&typeof init.body==='string'){
        ...
        p.session_id=SESSION;p.destino='integrado';
